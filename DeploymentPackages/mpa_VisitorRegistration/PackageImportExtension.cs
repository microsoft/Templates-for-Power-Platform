...
namespace mpa_VisitorRegistration
{
    /// <summary>
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => "mpa_VisitorRegistration";

        /// <summary>
        /// Long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport => "mpa_VisitorRegistration";

        /// <summary>
        /// Description of the package, used in the package selection UI
        /// </summary>
        public override string GetImportPackageDescriptionText => "mpa_VisitorRegistration";
