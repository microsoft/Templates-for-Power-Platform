...
namespace mpa_AppointmentBooking
{
    /// <summary>
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => "mpa_AppointmentBooking";

        /// <summary>
        /// Long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport => "mpa_AppointmentBooking";

        /// <summary>
        /// Description of the package, used in the package selection UI
        /// </summary>
        public override string GetImportPackageDescriptionText => "mpa_AppointmentBooking";
