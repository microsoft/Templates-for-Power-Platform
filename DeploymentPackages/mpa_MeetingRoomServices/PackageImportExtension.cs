...
namespace mpa_MeetingRoomServices
{
    /// <summary>
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => "mpa_MeetingRoomServices";

        /// <summary>
        /// Long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport => "mpa_MeetingRoomServices";

        /// <summary>
        /// Description of the package, used in the package selection UI
        /// </summary>
        public override string GetImportPackageDescriptionText => "mpa_MeetingRoomServices";
