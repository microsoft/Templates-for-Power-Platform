...
namespace mpa_Kudos.DeploymentPackage
{
    /// <summary>
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => "mpa_Kudos.DeploymentPackage";

        /// <summary>
        /// Long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport => "mpa_Kudos.DeploymentPackage";

        /// <summary>
        /// Description of the package, used in the package selection UI
        /// </summary>
        public override string GetImportPackageDescriptionText => "mpa_Kudos.DeploymentPackage";
